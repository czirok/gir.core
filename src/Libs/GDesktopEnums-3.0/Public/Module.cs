...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>GDesktopEnums</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="GDesktopEnums" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// GDesktopEnums. If the given DllImportResolver receives the library name "GDesktopEnums" it has to return a pointer
    /// to the desired native GDesktopEnums binary.
    /// </summary>
    /// <remarks>
