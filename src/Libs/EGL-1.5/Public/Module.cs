...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>EGL</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="EGL" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// EGL. If the given DllImportResolver receives the library name "EGL" it has to return a pointer
    /// to the desired native EGL binary.
    /// </summary>
    /// <remarks>
