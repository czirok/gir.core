...
public static class GckModule
{
    ...
    public static void Initialize()
    {
        ...
        NativeLibrary.SetDllImportResolver(typeof(GckModule).Assembly, CustomDllImportResolver ?? Internal.ImportResolver.Resolve);
    ...
    /// Gck. If the given DllImportResolver receives the library name "Gck" it has to return a pointer
    /// to the desired native Gck binary.
    /// </summary>
    /// <remarks>
