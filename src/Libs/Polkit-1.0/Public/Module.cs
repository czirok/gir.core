...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>Polkit</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="Polkit" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// Polkit. If the given DllImportResolver receives the library name "Polkit" it has to return a pointer
    /// to the desired native Polkit binary.
    /// </summary>
    /// <remarks>
