...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>Atk</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="Atk" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// Atk. If the given DllImportResolver receives the library name "Atk" it has to return a pointer
    /// to the desired native Atk binary.
    /// </summary>
    /// <remarks>
