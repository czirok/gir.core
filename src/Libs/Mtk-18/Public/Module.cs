...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>Mtk</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="Mtk" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// Mtk. If the given DllImportResolver receives the library name "Mtk" it has to return a pointer
    /// to the desired native Mtk binary.
    /// </summary>
    /// <remarks>
