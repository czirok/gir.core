...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>PolkitAgent</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="PolkitAgent" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// <item><description><see cref="Polkit.Module" /></description></item>
    /// </list>
    /// </remarks>
    ...
    /// PolkitAgent. If the given DllImportResolver receives the library name "PolkitAgent" it has to return a pointer
    /// to the desired native PolkitAgent binary.
    /// </summary>
    /// <remarks>
