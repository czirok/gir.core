...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>Gvc</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="Gvc" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// Gvc. If the given DllImportResolver receives the library name "Gvc" it has to return a pointer
    /// to the desired native Gvc binary.
    /// </summary>
    /// <remarks>
