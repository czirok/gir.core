...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>NM</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="NM" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// NM. If the given DllImportResolver receives the library name "NM" it has to return a pointer
    /// to the desired native NM binary.
    /// </summary>
    /// <remarks>
