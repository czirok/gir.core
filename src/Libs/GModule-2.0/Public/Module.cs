...
public static class InitializeModule
{
    private static bool IsInitialized;
    private static DllImportResolver? CustomDllImportResolver;

    /// <summary>
    /// Initialize the <c>GModule</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="GModule" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    public static void Initialize()
    {
        ...
        NativeLibrary.SetDllImportResolver(typeof(InitializeModule).Assembly, CustomDllImportResolver ?? Internal.ImportResolver.Resolve);
    ...
    /// GModule. If the given DllImportResolver receives the library name "GModule" it has to return a pointer
    /// to the desired native GModule binary.
    /// </summary>
    /// <remarks>
